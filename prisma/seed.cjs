...
async function main() {
  ...
  const products = await Promise.all([
    // --- ORIGINAL PRODUCTS (Moved to top so Reviews map correctly to indices 0-3) ---
    // Product 0: Kintsugi Tea Bowl
    prisma.product.create({
      data: {
        ...
        categoryId: teaware.id,
      },
    }),
    // Product 1: Bizen Ware Plate Set
    prisma.product.create({
      data: {
        id: randomUUID(),
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A versatile, wide-rimmed deep plate perfect for pasta, salads, or stews. Featuring a subtle, speckled oatmeal glaze and a smooth matte finish, these bowls are designed for both everyday dining and special gatherings.',
        price: 950.0,
        ...
        metaTitle:
          'Artisanal Ceramic Pasta Bowl - Oatmeal Finish | Basho by Shivangi',
        metaDescription:
          'Discover the Basho Oatmeal Pasta Bowl. Hand-glazed stoneware with a minimalist aesthetic, perfect for modern tablescapes.',
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A masterfully handcrafted shallow ceramic bowl featuring an organic, undulating rim. The interior is finished with a speckled moss-green matte glaze, while the exterior showcases the raw, earthy texture of terracotta stoneware.',
        price: 1850.0,
        ...
        metaDescription:
          'Elevate your dining with the Basho organic shallow bowl. Handcrafted stoneware featuring a unique green glaze.',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'A stunning, hand-sculpted serving platter inspired by the gentle curves of a ginkgo leaf. Its organic undulations create natural sections, making it perfect for arranging crackers, fruits, and cheeses for a grazing board. Finished in a soft, speckled white glaze.',
        price: 68.0,
        stock: 15,
        ...
        metaDescription:
          'Elevate your hosting with the Organic Ginkgo Serving Platter. A white ceramic grazing board perfect for appetizers and cheese pairings.',
    ...
    prisma.product.create({
      data: {
        ...
        description:
          "These hand-thrown bowls feature a tactile fluted exterior that fits perfectly in the hand. Glazed in harmonious two-tone palettes reminiscent of earth and sky—rusts, moss greens, teals, and soft pinks. The unglazed foot reveals the raw stoneware clay and bears the signature 'basho' stamp.",
        price: 28.0,
        stock: 24,
        ...
        material: 'Stoneware',
        metaDescription:
          'Discover the Basho Fluted Accent Bowl. Hand-thrown ceramic bowls with unique two-tone glazes and a tactile ribbed texture.',
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'Bring the garden inside. These sweet mugs feature a soft grey glaze serving as a canvas for hand-painted wildflowers in fresh greens and pops of red. A delicate and cheerful vessel for your morning tea or coffee.',
        price: 38.0,
        stock: 12,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'Modern design meets rustic texture. This mug features a matte teal glaze intersected by raw, unglazed geometric lines that create a striking visual contrast. The sturdy handle and thick walls keep your beverage warm while offering a comfortable grip.',
        price: 35.0,
        stock: 18,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'Dive into the deep blue with the Indigo Storm Mug. The complex, layered glaze creates a unique mottled effect, reminiscent of ocean currents or a night sky. Each mug is unique, with slight variations in the blue tones.',
        price: 35.0,
        stock: 15,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A functional masterpiece for your kitchen. This hand-thrown ceramic grater features a raised, textured center perfect for grating ginger, garlic, nutmeg, or hard cheeses directly into the dish. Finished with a convenient pouring spout and a warm, earthy brown glaze.',
        price: 32.0,
        stock: 20,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'These jewel-like small bowls are perfect for soy sauce, dips, olives, or mise en place. Available in a variety of glazes inspired by the sea shore—deep lagoon blues, seafoam greens, and sandy browns. Each one is a unique discovery.',
        price: 18.0,
        stock: 30,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A symbol of giving and receiving. These sculpted dishes are shaped like cupped hands, perfect for holding crystals, jewelry, sage bundles, or simply standing alone as a piece of art. Available in four distinct glaze finishes.',
        price: 45.0,
        stock: 8,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A study in contrasts. This serving bowl features a raw, textured terracotta exterior that feels grounded and rustic, paired with a vibrant golden-mustard interior glaze that creates a warm glow. Perfect for serving salads, fruits, or pasta.',
        price: 55.0,
        stock: 8,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'Soft, dreamy hues define these oval plates. Featuring a two-tone glaze application that mimics a horizon line, these plates are available in Mint/Pink and Earth/Mint combinations. Their unique egg shape adds a contemporary touch to any table setting.',
        price: 42.0,
        stock: 24,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'Add a touch of whimsy to your kitchen with these charming storage jars. Each lid features a hand-sculpted bird finial. Glazed in soft, earthy gradients of pink, grey, and moss green, these jars are perfect for storing pickles, jams, sugar, or trinkets.',
        price: 48.0,
        stock: 10,
        images: [
          '/images/products/IMG_6875.jpg',
          '/images/products/IMG_6876.jpg',
          '/images/products/IMG_6880.jpg',
        ],
        // Category: Dinnerware
        categoryId: dinnerware.id,
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A playful collection of hexagonal plates featuring soft pastel glazes in blush pink, seafoam green, and earthy browns. The geometric shape adds a modern touch to fruit displays or dessert service.',
        price: 1200.0,
        stock: 12,
        ...
        metaDescription:
          'Geometric hexagonal plates in soft pastel tones. Perfect for modern plating and serving fruits or desserts.',
        leadTime: '2-4 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'An exquisite ceramic tea set featuring a teapot with a natural bamboo handle and a charming sculpted sparrow on the lid. Accompanied by matching cups, glazed in a soothing earthy taupe.',
        price: 3800.0,
        originalPrice: 4200.0,
        stock: 5,
        images: [
          '/images/products/IMG_6878.jpg',
          '/images/products/IMG_6879.jpg',
        ],
        ...
        metaTitle:
          'Japanese Style Tea Set with Bamboo Handle | Sparrow Collection',
        metaDescription:
          'A serene tea set with a bamboo handle and sparrow detail. Perfect for ritualistic tea brewing.',
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A set of handcrafted stoneware tumblers featuring deep midnight blue and slate grey glazes. These handle-less cups offer a minimalist silhouette, perfect for green tea, sake, or water.',
        price: 850.0,
        originalPrice: 950.0,
        stock: 15,
        ...
        metaDescription:
          'Shop our Midnight & Slate tumblers. Minimalist ceramic cups glazed in deep blues and greys, perfect for tea or coffee.',
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A compact, modern teapot defined by its clean white body and a contrasting deep forest green lid. Its round form and short spout make it ideal for brewing personal servings of loose-leaf tea.',
        price: 1800.0,
        stock: 8,
        ...
        metaDescription:
          'Brew in style with our Forest Lid Minimalist Teapot. A compact design for the modern tea lover.',
        leadTime: '2-4 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'A poetic sculptural piece shaped as cupped hands. Available in pristine white and earthy brown, these bowls are perfect for holding ritual crystals, jewelry, or simply serving as a reminder of gratitude.',
        price: 1500.0,
        stock: 10,
        ...
        metaDescription:
          'Sculpted ceramic hands for decor or ritual use. A unique piece symbolizing offering and gratitude.',
        leadTime: '3-5 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'A striking ceramic plate defining the balance between raw nature and refined elegance. Half dipped in a smooth cream glaze, leaving the textured, sandy brown clay exposed on the other half.',
        price: 950.0,
        stock: 20,
        images: [
          '/images/products/IMG_9353.jpg',
          '/images/products/IMG_9351-2.jpg',
        ],
        categoryId: dinnerware.id, // Dinnerware
        color: 'Cream / Brown',
        material: 'Stoneware',
        ...
        metaDescription:
          'Hand-thrown ceramic plate featuring a raw clay and cream glaze contrast. A perfect rustic addition to your table setting.',
        leadTime: '3-5 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'Sturdy stoneware mugs that celebrate the beauty of raw materials. The base is left unglazed to show the gritty, warm clay, while the top is dipped in a thick, creamy glaze.',
        price: 750.0,
        stock: 30,
        ...
        metaDescription:
          'Enjoy your morning brew in our Rustic Dipped Clay Mugs. Featuring exposed stoneware and a creamy glaze finish.',
        leadTime: '2-3 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'Minimalist espresso mugs featuring a soft cream speckled glaze and comfortable loop handles. These petite cups are designed for the perfect shot of coffee.',
        price: 850.0,
        stock: 30,
        ...
        metaDescription:
          'Enjoy your morning brew in our Speckled Cream Espresso Mugs. Handcrafted for coffee lovers.',
        leadTime: '2-3 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'An elegant ceramic tea set including a teapot and two matching cups. The classic white body is sophisticatedly accented with deep emerald green rims and lids.',
        price: 2450.0,
        stock: 8,
        ...
        metaDescription:
          'Elevate your tea ritual with the Emerald Rim Tea Set. White ceramic with deep green accents.',
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'Elegantly crafted dinner plates with organic, ruffled edges and a soft cream glaze. The textured surface adds a tactile element to your dining experience, perfect for rustic or farmhouse aesthetics.',
        price: 2200.0,
        stock: 18,
        ...
        metaDescription:
          'Shop our Ruffled Edge Cream Platter Set. Organic shapes meet elegant dining.',
    ...
    prisma.product.create({
      data: {
        ...
        description:
          'A rustic serving combination featuring a large flat plate and a matching deep bowl. The earthy brown base is contrasted by a sweeping cream glaze, resembling clouds over a landscape.',
        price: 2100.0,
        stock: 12,
        ...
        metaDescription:
          'Serve in style with the Earth & Cloud Serving Duo. Handcrafted ceramic bowl and plate set.',
        leadTime: '3-5 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'A stunning set of two handcrafted stoneware plates featuring a warm earthy brown glaze contrasted with organic, cream-colored cloud patterns. Perfect for serving main courses and sides with a rustic touch.',
        price: 1850.0,
        stock: 15,
        ...
        metaDescription:
          'Shop the Cloudscape Ceramic Plate Set. Hand-glazed stoneware with an earthy aesthetic.',
        leadTime: '3-5 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          "Whimsical ceramic fortune cookies designed to hold personalized notes, affirmations, or wishes. A perfect mindfulness tool or a thoughtful gift for a loved one. Each cookie features a 'Dear Me' inscription.",
        price: 1200.0,
        stock: 25,
        ...
        metaDescription:
          'Discover our Ceramic Fortune Cookie Keepsakes. Store your wishes and affirmations in style.',
        leadTime: '2-3 business days',
      },
    }),
    prisma.product.create({
      data: {
        ...
        description:
          'Start your day with art. This complete breakfast collection includes two plates, two mugs, and a pitcher, all united by the signature earth and cream glaze design.',
        price: 4800.0,
  ...
  // --- REVIEWS ---
  // Note: products[0] refers to Kintsugi Tea Bowl, products[1] to Bizen Ware, etc.
