          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-10">
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-1">
              <div className="mb-6">
                ...
                <p className="text-stone-600 leading-relaxed mb-6 max-w-xs text-sm">
                ...
                <div className="flex items-center gap-3">
                  {[
                    ...
                    <motion.a
                      ...
                      whileHover={{ y: -3 }}
                      className="w-9 h-9 rounded-full bg-[#EDD8B4]/20 flex items-center justify-center text-[#8E5022] hover:bg-[#8E5022] hover:text-white transition-all duration-300"
                    >
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item.href}>
                    <Link
                      href={item.href}
                      className="flex items-center gap-2 text-stone-600 hover:text-[#C85428] transition-colors group text-sm"
                    >
                      <ArrowUpRight className="h-3 w-3 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" />
                      {item.label}
                    </Link>
                  </li>
                ))}
