    ...
    <div className="font-sans text-stone-800">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            <motion.div variants={fadeInUp}>
              <span className="text-[#8E5022] uppercase tracking-[0.3em] text-xs md:text-sm font-medium mb-4 inline-flex items-center gap-2">
                <Sparkles className="w-4 h-4" /> The Studio Sessions
              </span>
              <h1 className="font-serif text-4xl md:text-7xl text-[#442D1C] mb-6 leading-tight">
                Connect with <br />
      ...
      <section className="pb-32 px-4">
        <div className="max-w-7xl mx-auto">
          {/* Controls Bar */}
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 mb-12 pt-8">
              ...
              <div className="flex gap-2">
                {STATUS_FILTERS.map((status) => (
                  <button
                    ...
                    className={`px-5 py-2.5 md:px-6 md:py-3 rounded-full font-medium whitespace-nowrap transition-all flex-shrink-0 text-sm md:text-base ${
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="w-full lg:w-auto justify-center flex items-center gap-2 bg-white border-2 border-stone-200 rounded-xl px-6 py-3 hover:border-[#8E5022] transition-colors"
              >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {LEVELS.map((level) => (
                      ...
                      >
                        ...
                        />
                        <div
                          className={`px-4 py-2.5 md:px-5 md:py-3 rounded-xl border-2 transition-all font-medium text-sm md:text-base ${
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {[...Array(6)].map((_, i) => (
                ...
                >
                  <div className="h-64 md:h-72 bg-stone-200 animate-pulse" />
            ...
            >
              {filteredWorkshops.length > 0 ? (
                ...
                >
                  ...
                  <h3 className="font-serif text-2xl md:text-3xl text-[#442D1C] mb-4">
                    No workshops found
                  </h3>
                  <p className="text-stone-600 mb-8 max-w-md mx-auto text-sm md:text-base">
  ...
  return (
    <motion.div
      ...
      className={`group relative bg-white rounded-3xl overflow-hidden flex flex-col h-full ${
        isPast
          ? 'opacity-60 grayscale border border-stone-200'
